...
See how Lightwell transforms open source vulnerability remediation from a weeks-long manual process into an automated operation using AAP, TPA, TSF and RHAI.
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/lightwell-workshop`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/lightwell-workshop
   ```
3. `cd lightwell-workshop`
